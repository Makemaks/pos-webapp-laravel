...
class WarehouseFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
                ...
                "warehouse_cost_override"=> $this->faker->randomElement($array = array (NULL,$this->faker->randomFloat($nbMaxDecimals = NULL, $min = 0, $max = 50))),
                ...
                "warehouse_type" => $this->faker->numberBetween($min = 0, $max = 5),
                "warehouse_cost_type" => $this->faker->numberBetween($min = 0, $max = 1),
