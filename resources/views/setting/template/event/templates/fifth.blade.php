<div class="uk-container">
    <div class="uk-card uk-box-shadow-large uk-card-body uk-background-muted uk-padding-remove">
        <div uk-grid class="uk-margin-remove">
            <div class="uk-width-expand uk-padding-remove uk-background-default uk-border-rounded">
                <div uk-grid class="uk-margin-remove uk-height-1-1">
                    ...
                    <div class="uk-width-1-1 uk-margin-remove uk-background-primary">
            ...
            <div class="uk-width-auto uk-width-medium uk-padding-small uk-background-default uk-border-rounded">
