...
class WarehouseFactory extends Factory
{
    ...
    public function definition()
    {
        return [
                ...
                "warehouse_price"=> $this->faker->randomElement($array = array (NULL,$this->faker->randomFloat($nbMaxDecimals = NULL, $min = 0, $max = 50))),
                "warehouse_quantity"=>  $this->faker->numberBetween($min = 1, $max = 50),
               
                "warehouse_type" => $this->faker->numberBetween($min = 0, $max = 1),
        ];
    }
}
