<div class="uk-container">
    <div class="uk-card uk-box-shadow-large uk-padding-remove uk-card-body uk-background-muted">
        <div uk-grid class="uk-margin-remove">
            <div class="uk-width-auto uk-padding-remove uk-flex-first uk-background-muted">
                <div class="uk-width-medium uk-padding-small uk-text-center uk-text-primary">
            ...
            <div class="uk-width-expand uk-flex-last uk-background-secondary uk-padding-remove">
                <div class="uk-padding-small uk-width-1-1 uk-text-center">
                    <h2 class="uk-margin-remove uk-text-primary">PosWebapp</h2>
                </div>
            </div>
        </div>
        ...
        <div uk-grid class="uk-margin-remove">
            ...
            <div class="uk-width-expand uk-flex-last uk-padding-remove uk-background-secondary">
