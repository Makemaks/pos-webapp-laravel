<div class="uk-container">
    <div class="uk-card uk-box-shadow-large uk-card-body uk-background-muted uk-padding-remove">
        <div uk-grid class="uk-margin-remove">
            <div class="uk-width-expand uk-flex-first uk-padding-small uk-background-default uk-border-rounded">
                <div uk-grid>
            ...
            <div class="uk-width-small uk-flex-last uk-padding-remove uk-background-muted uk-border-rounded">
                <div class="uk-padding-remove uk-width-1-1 uk-text-center uk-height-1-1">
                    <img src="{{ asset('images/qr_code_vertical.png') }}" width="100" height="100" class="uk-height-1-1">
                </div>
            </div>
        </div>
    </div>
