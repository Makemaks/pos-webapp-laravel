    ...
    <div class="uk-card uk-box-shadow-large uk-padding-remove uk-card-body uk-background-muted">
        <div uk-grid class="uk-margin-remove">
            <div class="uk-width-auto uk-padding-remove uk-flex-first uk-background-muted">
                <div class="uk-width-medium uk-padding-small uk-text-center uk-text-secondary">
            ...
            <div class="uk-width-expand uk-flex-last uk-background-muted uk-padding-remove">
                <div class="uk-padding-small uk-width-1-1 uk-text-center uk-text-secondary">
                    <h2 class="uk-margin-remove">PosWebapp</h2>
                </div>
            </div>
        </div>

        <div uk-grid class="uk-margin-remove uk-background-default">
            <div class="uk-width-auto uk-flex-first uk-padding-remove">
