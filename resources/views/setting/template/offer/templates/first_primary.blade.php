<div class="uk-container">
    <div class="uk-card uk-box-shadow-large uk-card-body uk-border-rounded uk-background-primary">
        <div uk-grid>
                    ...
                    <form>
                        <div class="uk-margin">
                            <div class="uk-form-controls">
                                <input class="uk-input uk-border-rounded uk-background-muted" id="name" type="text" placeholder="Name">
                            </div>
                        </div>
                        <div class="uk-margin">
                            <div class="uk-form-controls">
                                <input class="uk-input uk-border-rounded uk-background-muted" id="expired" type="text" placeholder="Expired">
                            </div>
                        </div>
                    </form>
                </div>
