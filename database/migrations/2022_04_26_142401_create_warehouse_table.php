...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('warehouse', function (Blueprint $table) {
            ...
            $table->float('warehouse_stock_price')->nullable();
            $table->bigInteger('warehouse_stock_id');
            $table->bigInteger('warehouse_stock_quantity');
            ...
            /* $table->json('warehouse_stock_price')->nullable();
            $table->json('warehouse_stock_price_quantity')->nullable(); */
