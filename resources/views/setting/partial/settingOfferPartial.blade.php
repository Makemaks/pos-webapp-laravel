                                    ...
                                    <select class="uk-select" id="form-stacked-select"
                                        ...
                                        @foreach (Setting::SettingOfferStatus() as $key_stock_offer => $item_stock_offer)
                                            <option value="{{ $key_stock_offer }}"
                                                @if ($key_stock_offer == $stockitem) selected @endif>
                                                {{ $item_stock_offer }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div>
                            ...
                            <div uk-grid>
                                @foreach (Carbon::getDays() as $key_days => $item_days)
                                    ...
                                    <div>
                                        <label class="uk-form-label"
                                            for="form-stacked-text">{{ Str::upper(Str::limit($item_days, 3, '')) }}</label>
                                        <div class="uk-form-controls">
                                            <input class="uk-checkbox" type="checkbox"
                                                name="form[setting_offer][available_day][]" value="{{ ++$key_days }}"
                                                {{ $checked }}>
                                        </div>
                                    </div>
                                @endforeach
