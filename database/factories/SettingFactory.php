...
class SettingFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        for ($i = 1; $i <= 2; $i++) {
            $setting_building[$i] = [
                'status'      => $this->faker->randomElement(Setting::buildingStatus()),
        ...
        for ($i = 1; $i <= 3; $i++) {
            $setting_room[$i] = [
                'setting_building_id' => $this->faker->numberBetween(1, 2),
                'status' => $this->faker->randomElement(Setting::roomStatus()),
