...
<div class="uk-grid-small uk-child-width-auto" uk-grid>
    <div><button type="button" id="minusID-{{$cartValue}}" onclick="Quantity(0, {{$cartValue}})"  class="uk-text-danger uk-button uk-button-default uk-border-rounded" uk-icon="minus"></button></div>                           
