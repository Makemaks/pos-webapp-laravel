                                        ...
                                        @foreach ($data['settingModel']->setting_offer as $keyStockoffer => $itemStockoffer)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="uk-width-auto"><a class="uk-button uk-button-default uk-border-rounded" uk-icon="icon: pencil" href="{{route('setting.edit', ['setting' => $data['settingModel']->setting_id, 'stock_offer[index]' => $keyStockoffer])}}"></a></div>
                                                        </td>    
                                                    </tr>
