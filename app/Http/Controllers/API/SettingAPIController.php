    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('settingKeyFormID')) {
            ...
            if ($setting_key['setting_key_group'] != '' && $setting_key['setting_key_type'] != '') {
                ...
                $setting_key = collect($this->settingModel->setting_key)->where('setting_key_group', $setting_key['setting_key_group'])
                ->where('setting_key_type', $setting_key['setting_key_type'])->toArray();
            }

            //$settingModel['setting_key'] = [ '0' => $setting_key ];
            $this->settingModel->setting_key = [ '0' => $setting_key ];
